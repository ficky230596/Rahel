...
<body>
  ...
  <div class="container py-4">
    <h3>Peleton</h3>
    <button class="btn btn-success mb-3" data-bs-toggle="modal" data-bs-target="#mAdd">Tambah Peleton</button>
      ...
      <div class="modal-content">
        <form method="post">
          ...
          <div class="modal-body">
            <div class="mb-2"><label class="form-label">Nama Peleton</label><input name="nama" class="form-control" required></div>
          </div>
      ...
      <div class="modal-content">
        <form method="post">
          ...
          <div class="modal-body">
            ...
            <div class="mb-2"><label class="form-label">Nama Peleton</label><input name="nama" id="edit-nama" class="form-control" required></div>
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Tutup</button>
      ...
      <div class="modal-content">
        <form method="post">
          ...
          <div class="modal-body">
            ...
            <p>Apakah Anda yakin ingin menghapus Peleton **<span id="delete-nama-span"></span>**?</p>
          </div>
          <div class="modal-footer">
