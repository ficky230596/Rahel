...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    /* Form controls */
    .form-label{color:rgba(255,255,255,0.75); font-size:0.88rem;}
    .form-control{
    ...
    .btn-danger:hover{ transform: translateY(-3px); filter:brightness(1.02); box-shadow: 0 14px 30px rgba(255,95,109,0.18); }
    .btn-danger:active{ transform: translateY(-1px); box-shadow: 0 6px 16px rgba(0,0,0,0.28); }
    ...
    @media (max-width:420px){
      .login-card{ padding:20px; border-radius:12px; width:100%; }
      .btn-danger{ height:44px; border-radius:10px; }
    }
  </style>
</head>
